const translation = {
  ...
  welcome: '👋 Welcome to New OpenAI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting New OpenAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on New OpenAI',
  invalid: 'The link has expired',
  explore: 'Explore New OpenAI',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on New OpenAI and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The New OpenAI Enterprise license for your workspace has expired. Please contact your administrator to continue using New OpenAI.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect New OpenAI license server. Please contact your administrator to continue using New OpenAI.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The New OpenAI Enterprise license for your workspace is inactive. Please contact your administrator to continue using New OpenAI.',
}
